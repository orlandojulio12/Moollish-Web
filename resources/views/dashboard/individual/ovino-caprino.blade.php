    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title d-flex align-items-center">
                ...
                <h5>Dashboard Individual - Censo Ovinos y Caprinos</h5>
            </div>
        </div>
    </div>
@endsection
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="selector-card">
                ...
                <p class="text-muted">Selecciona un predio para ver su análisis individual de ovinos y caprinos</p>
                
                <form method="GET" action="{{ route('dashboard.individual.ovino.caprino') }}">
                    <div class="row">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('dashboard.comparativo.ovino.caprino') }}" class="btn btn-outline-primary">
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="kpi-predio">
                    ...
                    <div class="kpi-subtitle">Total Ovinos y Caprinos</div>
                    <hr style="border-color: rgba(0,0,0,0.2);">
                    <div class="row mt-3">
                        <div class="col-6">
                            <strong>{{ number_format($datosPredio['ovinos']) }}</strong>
                            <br><small>Ovinos</small>
                        </div>
                        <div class="col-6">
                            <strong>{{ number_format($datosPredio['caprinos']) }}</strong>
                            <br><small>Caprinos</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="kpi-promedio">
                    ...
                    <div class="row mt-3">
                        <div class="col-6">
                            <strong>{{ number_format($promedioMunicipal->avg_ovinos, 0) }}</strong>
                            <br><small>Ovinos</small>
                        </div>
                        <div class="col-6">
                            <strong>{{ number_format($promedioMunicipal->avg_caprinos, 0) }}</strong>
                            <br><small>Caprinos</small>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="kpi-comparacion {{ $comparacion['total_percent'] >= 0 ? 'positive' : 'negative' }}">
                    ...
                    <hr>
                    <div style="color: #333;">
                        <strong>{{ $comparacion['total_diff'] >= 0 ? '+' : '' }}{{ number_format($comparacion['total_diff']) }}</strong> animales
...
// Verificar que Chart.js esté disponible
    ...
    const ctx = document.getElementById('chartComparativo');
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Total', 'Ovinos', 'Caprinos'],
                datasets: [
                    {
                        label: 'Mi Predio',
                        data: [{{ $datosPredio['total'] }}, {{ $datosPredio['ovinos'] }}, {{ $datosPredio['caprinos'] }}],
                        backgroundColor: '#667eea',
                        borderRadius: 8
                    },
                    {
                        label: 'Promedio Municipal',
                        data: [{{ $promedioMunicipal->avg_total }}, {{ $promedioMunicipal->avg_ovinos }}, {{ $promedioMunicipal->avg_caprinos }}],
