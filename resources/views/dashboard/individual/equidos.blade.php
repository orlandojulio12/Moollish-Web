    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title d-flex align-items-center">
                ...
                <h5>Dashboard Individual - Censo Équidos</h5>
            </div>
        </div>
    </div>
@endsection
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="selector-card">
                ...
                <p class="text-muted">Selecciona un predio para ver su análisis individual de équidos</p>
                
                <form method="GET" action="{{ route('dashboard.individual.equidos') }}">
                    <div class="row">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('dashboard.comparativo.equidos') }}" class="btn btn-outline-primary">
    ...
    @if($datosPredio)
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="kpi-predio">
                    ...
                    <div class="kpi-subtitle">Total Équidos</div>
                    <hr style="border-color: rgba(255,255,255,0.3);">
                    <div class="row mt-3">
                        <div class="col-4">
                            <strong>{{ number_format($datosPredio['caballar']) }}</strong>
                            <br><small>Caballar</small>
                        </div>
                        <div class="col-4">
                            <strong>{{ number_format($datosPredio['mular']) }}</strong>
                            <br><small>Mular</small>
                        </div>
                        <div class="col-4">
                            <strong>{{ number_format($datosPredio['asnal']) }}</strong>
                            <br><small>Asnal</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="kpi-promedio">
                    ...
                    <div class="row mt-3">
                        <div class="col-4">
                            <strong>{{ number_format($promedioMunicipal->avg_caballar, 0) }}</strong>
                            <br><small>Caballar</small>
                        </div>
                        <div class="col-4">
                            <strong>{{ number_format($promedioMunicipal->avg_mular, 0) }}</strong>
                            <br><small>Mular</small>
                        </div>
                        <div class="col-4">
                            <strong>{{ number_format($promedioMunicipal->avg_asnal, 0) }}</strong>
                            <br><small>Asnal</small>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="kpi-comparacion {{ $comparacion['total_percent'] >= 0 ? 'positive' : 'negative' }}">
                    ...
                    <hr>
                    <div style="color: #333;">
                        <strong>{{ $comparacion['total_diff'] >= 0 ? '+' : '' }}{{ number_format($comparacion['total_diff']) }}</strong> équidos
        ...
        <!-- Gráfico Comparativo por Tipo -->
        <div class="row mb-4">
            <div class="col-12">
                <div class="chart-card">
                    <h5><i class="bi bi-bar-chart-fill"></i> Mi Predio vs Promedio Municipal por Tipo</h5>
...
// Verificar que Chart.js esté disponible
    ...
    const ctx = document.getElementById('chartComparativo');
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Total Équidos', 'Caballar', 'Mular', 'Asnal'],
                datasets: [
                    {
                        label: 'Mi Predio',
                        data: [{{ $datosPredio['total'] }}, {{ $datosPredio['caballar'] }}, {{ $datosPredio['mular'] }}, {{ $datosPredio['asnal'] }}],
                        backgroundColor: '#4facfe',
                        borderRadius: 8
                    },
                    {
                        label: 'Promedio Municipal',
                        data: [{{ $promedioMunicipal->avg_total }}, {{ $promedioMunicipal->avg_caballar }}, {{ $promedioMunicipal->avg_mular }}, {{ $promedioMunicipal->avg_asnal }}],
