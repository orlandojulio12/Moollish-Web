    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title d-flex align-items-center">
                ...
                <h5>Dashboard Individual - Censo Bufalinos</h5>
            </div>
        </div>
    </div>
@endsection
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="selector-card">
                ...
                <p class="text-muted">Selecciona un predio para ver su análisis individual de bufalinos</p>
                
                <form method="GET" action="{{ route('dashboard.individual.bufalinos') }}">
                    <div class="row">
                        <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('dashboard.comparativo.bufalinos') }}" class="btn btn-outline-primary">
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="kpi-predio">
                    ...
                    <div class="kpi-subtitle">Total Bufalinos</div>
            ...
            <div class="col-md-4">
                <div class="kpi-comparacion {{ $comparacion['total_percent'] >= 0 ? 'positive' : 'negative' }}">
                    ...
                    <hr>
                    <div style="color: #333;">
                        <strong>{{ $comparacion['total_diff'] >= 0 ? '+' : '' }}{{ number_format($comparacion['total_diff']) }}</strong> bufalinos
    ...
    if (typeof Chart === 'undefined') {
     ...
     const ctx = document.getElementById('chartComparativo');
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Total Bufalinos', 'Hembras', 'Machos'],
                datasets: [
                    {
                        label: 'Mi Predio',
