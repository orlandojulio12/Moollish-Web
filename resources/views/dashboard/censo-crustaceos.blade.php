    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title d-flex align-items-center">
                ...
                <h5>Dashboard Regional - Censo Crustáceos</h5>
            </div>
        </div>
    </div>
@endsection
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-8 text-end">
                        <a href="{{ route('dashboard.censo.peces') }}" class="btn btn-outline-secondary">
                            <i class="bi bi-arrow-left"></i> Peces
                        </a>
                        <a href="{{ route('dashboard.censo.consolidado') }}" class="btn btn-success">
                            Consolidado <i class="bi bi-grid-3x3"></i>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="chart-card">
                <h5><i class="bi bi-bar-chart-fill"></i> Crustáceos por Municipio</h5>
                <canvas id="chartCensoCrustaceos" height="80"></canvas>
            </div>
        </div>
    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        <thead style="background: #ff6a00; color: white;">
                            <tr>
                                <th>Municipio</th>
                                <th class="text-end">Total Crustáceos</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><i class="bi bi-geo-alt-fill" style="color: #ff6a00;"></i> {{ $censo->municipio }}</td>
...
const ctx1 = document.getElementById('chartCensoCrustaceos');
new Chart(ctx1, {
    type: 'bar',
    data: {
        labels: municipios,
        datasets: [{
            label: 'Total Crustáceos',
            data: totales,
            backgroundColor: '#ff6a00',
            borderColor: '#ee0979',
            borderWidth: 2,
            borderRadius: 8,
            hoverBackgroundColor: '#ee0979'
        }]
    },
    options: {
        responsive: true,
            ...
            tooltip: {
                ...
                callbacks: {
                    label: function(context) {
                        return 'Total: ' + context.parsed.y.toLocaleString() + ' crustáceos';
                    }
                }
            }
        },
...
new Chart(ctx2, {
    ...
    data: {
        ...
        datasets: [{
            data: totalesEspecie,
            backgroundColor: ['#ff6a00', '#ee0979', '#E49B39', '#667eea', '#4facfe'],
            borderWidth: 2,
            borderColor: '#fff'
        }]
    },
...
function filtrarMunicipio() {
    ...
    window.location.href = '{{ route("dashboard.censo.crustaceos") }}?municipio=' + municipio;
}
