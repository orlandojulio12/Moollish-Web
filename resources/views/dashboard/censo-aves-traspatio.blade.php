...
@section('template_title')
    Dashboard Censo Aves Traspatio
@endsection
@section('styles')
<style>
    .dashboard-kpi {
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title d-flex align-items-center">
                ...
                <h5>Dashboard Regional - Censo Aves Traspatio</h5>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="filter-section">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-8 text-end">
                        <a href="{{ route('dashboard.censo.aves.comerciales') }}" class="btn btn-outline-secondary">
                            <i class="bi bi-arrow-left"></i> Aves Comerciales
                        </a>
                        <a href="{{ route('dashboard.censo.ovino.caprino') }}" class="btn btn-outline-secondary">
                            Ovinos/Caprinos <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="chart-card">
                <h5><i class="bi bi-bar-chart-fill"></i> Aves Traspatio por Municipio</h5>
            ...
            <div class="chart-card">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        <thead style="background: #30cfd0; color: white;">
                            <tr>
                                <th>Municipio</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><i class="bi bi-geo-alt-fill" style="color: #30cfd0;"></i> {{ $censo->municipio }}</td>
...
new Chart(ctx2, {
    ...
    data: {
        ...
        datasets: [{
            data: totalesTipo,
            backgroundColor: ['#30cfd0', '#E49B39', '#667eea', '#f5576c', '#4facfe'],
            borderWidth: 2,
            borderColor: '#fff'
        }]
    },
...
function filtrarMunicipio() {
    ...
    window.location.href = '{{ route("dashboard.censo.aves.traspatio") }}?municipio=' + municipio;
}
