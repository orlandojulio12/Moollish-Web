    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title d-flex align-items-center">
                <a href="{{ route('dashboard.censo.bufalinos') }}"><i class="bi bi-arrow-left" style="margin-right: 10px; font-size: 24px; color: black;"></i></a>
                <h5>Dashboard Comparativo - Censo Bufalinos</h5>
            </div>
        </div>
    </div>
@endsection
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="selector-card">
                ...
                <p class="text-muted">Selecciona entre 2 y 5 predios para comparar sus censos de bufalinos</p>
                
                <form id="formComparativo" method="GET" action="{{ route('dashboard.comparativo.bufalinos') }}">
                    <div class="row">
            ...
            <div class="col-12">
                <div class="alert alert-info">
                    ...
                    @foreach($comparacion as $index => $item)
                        <span class="predio-badge" style="background: {{ ['#667eea', '#E49B39', '#f5576c', '#4facfe', '#0ba360'][$index % 5] }}; color: white;">
                            {{ $item['nombre'] }}
                        </span>
                    @endforeach
                </div>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="chart-card">
                    <h5><i class="bi bi-bar-chart-fill"></i> Comparación de Total Bufalinos</h5>
...
const colores = ['#667eea', '#E49B39', '#f5576c', '#4facfe', '#0ba360'];
...
new Chart(ctx2, {
    ...
    data: {
        labels: predios,
        datasets: [
            { label: 'Hembras', data: hembras, backgroundColor: '#667eea', borderRadius: 6 },
            { label: 'Machos', data: machos, backgroundColor: '#764ba2', borderRadius: 6 }
        ]
    },
    options: {
        responsive: true,
