        ...
        <div class="header-grid">
            @if ($user->role->name === 'propietario')
                <div class="breadcrumb">
                    ...
                    <h3 class="cumb active-tab"> Caracterización </h3>
                </div>
            ...
            <div class="grid-playground">
                <a href="/users">
                    <div class="grid-card-end">
                        <span class="light-text">Caracterización</span>
                        <span class="title-card-end">Propietarios</span>
                        <div class="usuarios-orange"></div>
                ...
                <a href="/predios">
                    <div class="grid-card-end">
                        <span class="light-text">Caracterización</span>
                        <span class="title-card-end">Predios</span>
                        <div class="predios-orange"></div>
                        <span class="description">
