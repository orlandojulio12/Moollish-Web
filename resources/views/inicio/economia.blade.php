...
@section('styles')
    ...
    border: 1px solid #eaebef;
        ...
        .movimiento-orange {
            background-image: url('../../img/inicio/movimientosOrange.png');
            background-position: center;
            background-size: contain;
            width: 80px;
            height: 80px;
        ...
        <div class="header-grid">
             @if ($user->role->name === 'propietario')
                <div class="breadcrumb">
                    ...
                    <h3 class="cumb active-tab"> Economia </h3>
                </div>
            @elseif ($user->role->name === 'admin')
                <h3>Administrar Economias</h3>
            @endif
            <hr>
        </div>
                ...
                <div class="grid-playground">
                    <a href="{{ route('gastos.show') }}">
                        <div class="grid-card-end">
                            ...
                            <span class="title-card-end">Movimientos</span>
                            <div class="caracterizacion-orange"></div>
                            <span class="description">
                                Registra tus ingresos y egresos relacionados a tu predio.
                            </span>
                        </div>
                    </a>
                </div>
