...
@section('content')
    ...
    <div class="card-custom">
        <div class="header-grid">
            @if ($user->role->name === 'propietario')
                <div class="breadcrumb">
                    ...
                    <h3 class="cumb active-tab"> Animales </h3>
                </div>
        ...
        <div class="grid-end">
            <span>Detalla las características de tu predio: ubicación, topografía, suelo, recursos hídricos y más.
                Información esencial para la toma de decisiones.</span>
            <div class="grid-playground">
                <a href="{{route('inventario.index')}}">
                    <div class="grid-card-end">
                        <span class="light-text">Animales</span>
                        <span class="title-card-end">Ficha animal</span>
                        <div class="ficha-animal-orange"></div>
                        <span class="description">
                            Registra técnicos, distribuye tareas y mantén el control de las actividades.
                        </span>
                    </div>
                </a>

                <a href="{{route('MuerteAnimal.index')}}">
                    <div class="grid-card-end">
                        <span class="light-text">Animales</span>
                        <span class="title-card-end">Muerte animal</span>
                        <div class="muerte-orange"></div>
                        <span class="description">
                            Registra tu predio, administra permisos
                        </span>
                    </div>
                </a>
            </div>
