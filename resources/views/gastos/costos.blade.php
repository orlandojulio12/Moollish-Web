        ...
        <div class="page-header-left d-flex align-items-center">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Lista de Movimiento</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="header-grid">
            <div class="breadcrumb">
                ...
                <h3 class="cumb active-tab">Lista de Movimiento</h3>
            </div>
            <hr>
        </div>
        <div class="row">
                ...
                <div class="card stretch stretch-full">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3">
                            ...
                            <!-- Botón con margen automático a la izquierda para mantenerlo a la derecha -->
                            <a class="btn btn-primary ms-auto" data-bs-toggle="modal" data-bs-target="#editAreaModal">
                                {{ __('Crear Movimiento') }}
                            </a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <h5
                                                    ...
                                                    {{ number_format($gasto->cantidad, 2, '.', ',') }}</h5>
                                            </td>
                                            <!-- Muestra la cantidad -->
...
@section('modal')
    {{-- inicio de modales  --}}
        ...
        <div class="modal fade" id="editAreaModal{{ $gasto->id }}" tabindex="-1"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="naturaleza" id="naturaleza-update-{{ $gasto->id }}"
                                    ...
                                    <option value="Costos de ventas"
                                        {{ $gasto->planCuenta->naturaleza == 'Costos de ventas' ? 'selected' : '' }}>Costos
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="plan_cuenta" id="subcuenta-update-{{ $gasto->id }}"
                                    class="form-control" data-selected-id="{{ $gasto->plan_cuenta }}">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                naturalezaUpdateSelects.forEach(naturalezaUpdateSelect => {
                    ...
                    const selectedCategoriaCodcta = categoriaUpdateSelect.getAttribute('data-selected-categoria');
                    ...
                    function fillCategoriasUpdate(selectedNaturaleza) {
                        ...
                        const categoriasFiltradas = categoriasPrincipales.filter(categoria => {
                            const hasSubcuentas = subcuentas.some(subcuenta => subcuenta.codcta.startsWith(categoria.codcta) && subcuenta.naturaleza === selectedNaturaleza);
                    ...
                    function fillSubcuentasUpdate(selectedCategoria, selectedNaturaleza) {
                        ...
                        const subcuentasFiltradas = subcuentas.filter(subcuenta => subcuenta.codcta.startsWith(selectedCategoria) && subcuenta.naturaleza === selectedNaturaleza);
