        ...
        <div class="page-header-left d-flex align-items-center">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Lista de Ingresos</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="header-grid">
            <div class="breadcrumb">
                ...
                <h3 class="cumb active-tab">Lista de Ingresos</h3>
            </div>
            <hr>
        </div>
        <div class="row">
                        ...
                        <div class="d-flex justify-content-between align-items-center p-3">
                            ...
                            <h3 class="me-auto" style="width: 50%;">
                                ...
                                <i class="bi bi-currency-dollar"
                                    style="font-size: 24px; color: {{ $saldo < 0 ? 'red' : 'green' }};"></i>
                            ...
                            <div class="form-group">
                                ...
                                <select name="naturaleza" id="naturaleza-update-{{ $gasto->id }}"
                                    ...
                                    <option value="Ingresos"
                                        {{ $gasto->planCuenta->naturaleza == 'Ingresos' ? 'selected' : '' }}>Ingresos
                                    </option>
                                    <option value="Gastos"
