    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="d-flex align-items-center justify-content-center card shadow-sm p-3 mb-5 bg-white rounded">
                <div class="me-4">
                    <canvas id="graficaPrediosPropietarios" style="max-height: 500px; width: 500px;"></canvas>
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Obtiene los datos desde el controlador
            const propietarios = @json($propietarios);
            const totalPredios = @json($totalPredios);

            const ctx = document.getElementById('graficaPrediosPropietarios').getContext('2d');
            new Chart(ctx, {
                type: 'pie',
                data: {
                    labels: propietarios,
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Cantidad de Predios por Propietario',
                            font: {
                                size: 16
                            }
                        }
