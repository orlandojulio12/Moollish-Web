        ...
        <div class="page-header-left d-flex align-items-center">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">BOVINOS</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('content')
    ...
    <div class="content-area-body">
        <div class="card mb-0">
            <div class="card-body">
                @if ($censoExistente)
                    <form action="{{ route('censo.update', ['id' => $censoBovino->id]) }}" method="POST">
                        @csrf
                        @method('PUT')<!-- Método PUT para actualización -->

                        <!-- Input oculto para id_predio -->
                        <input type="hidden" name="id_predio" value="{{ $censoBovino->id_predio }}">

                        <!-- Campos para Hembras -->
                        <!-- Menos de 3 meses (Hembras) -->
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="men_3_meses_h" id="men_3_meses_h2"
                                value="{{ old('men_3_meses_h', $censoBovino->men_3_meses_h) }}"
                                oninput="calculateTotalHembras2()" required>
                        </div>

                        <!-- De 3 a 9 meses (Hembras) -->
                        <div class="mb-3">
                            <label for="tres_a_9_meses_h" class="form-label">De 3 a 9 meses (Hembras):</label>
                            <input type="number" class="form-control" name="tres_a_9_meses_h" id="3_a_9_meses_h2"
                                value="{{ old('tres_a_9_meses_h', $censoBovino->tres_a_9_meses_h) }}"
                                oninput="calculateTotalHembras2()" required>
                        </div>

                        <!-- De 9 a 12 meses (Hembras) -->
                        <div class="mb-3">
                            <label for="nueve_a_12_meses_h" class="form-label">De 9 a 12 meses (Hembras):</label>
                            <input type="number" class="form-control" name="nueve_a_12_meses_h" id="9_a_12_meses_h2"
                                value="{{ old('nueve_a_12_meses_h', $censoBovino->nueve_a_12_meses_h) }}"
                                oninput="calculateTotalHembras2()" required>
                        </div>

                        <!-- De 1 a 2 años (Hembras) -->
                        <div class="mb-3">
                            <label for="uno_a_2_años_h" class="form-label">De 1 a 2 años (Hembras):</label>
                            <input type="number" class="form-control" name="uno_a_2_años_h" id="1_a_2_años_h2"
                                value="{{ old('uno_a_2_años_h', $censoBovino->uno_a_2_años_h) }}"
                                oninput="calculateTotalHembras2()" required>
                        </div>

                        <!-- De 2 a 3 años (Hembras) -->
                        <div class="mb-3">
                            <label for="dos_a_3_años_h" class="form-label">De 2 a 3 años (Hembras):</label>
                            <input type="number" class="form-control" name="dos_a_3_años_h" id="2_a_3_años_h2"
                                value="{{ old('dos_a_3_años_h', $censoBovino->dos_a_3_años_h) }}"
                                oninput="calculateTotalHembras2()" required>
                        </div>

                        <!-- De 3 a 5 años (Hembras) -->
                        <div class="mb-3">
                            <label for="tres_a_5_años_h" class="form-label">De 3 a 5 años (Hembras):</label>
                            <input type="number" class="form-control" name="tres_a_5_años_h" id="3_a_5_años_h2"
                                value="{{ old('tres_a_5_años_h', $censoBovino->tres_a_5_años_h) }}"
                                oninput="calculateTotalHembras2()" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="may_5_años_h" id="may_5_años_h2"
                                value="{{ old('may_5_años_h', $censoBovino->may_5_años_h) }}"
                                oninput="calculateTotalHembras2()" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="total_hembras" id="total_hembras2"
                                value="{{ old('total_hembras', $censoBovino->total_hembras) }}" readonly>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="men_3_meses_m" id="men_3_meses_m2"
                                value="{{ old('men_3_meses_m', $censoBovino->men_3_meses_m) }}"
                                oninput="calculateTotalMachos2()">
                        </div>

                        <div class="mb-3">
                            <label for="3_a_9_meses_m" class="form-label">De 3 a 9 meses (Machos):</label>
                            <input type="number" class="form-control" name="3_a_9_meses_m" id="3_a_9_meses_m2"
                                value="{{ old('3_a_9_meses_m', $censoBovino->tres_a_9_meses_m) }}"
                                oninput="calculateTotalMachos2()">
                        </div>

                        <div class="mb-3">
                            <label for="9_a_12_meses_m" class="form-label">De 9 a 12 meses (Machos):</label>
                            <input type="number" class="form-control" name="9_a_12_meses_m" id="9_a_12_meses_m2"
                                value="{{ old('9_a_12_meses_m', $censoBovino->nueve_a_12_meses_m) }}"
                                oninput="calculateTotalMachos2()">
                        </div>

                        <div class="mb-3">
                            <label for="1_a_2_años_m" class="form-label">De 1 a 2 años (Machos):</label>
                            <input type="number" class="form-control" name="1_a_2_años_m" id="1_a_2_años_m2"
                                value="{{ old('1_a_2_años_m', $censoBovino->uno_a_2_años_m) }}"
                                oninput="calculateTotalMachos2()">
                        </div>

                        <div class="mb-3">
                            <label for="2_a_3_años_m" class="form-label">De 2 a 3 años (Machos):</label>
                            <input type="number" class="form-control" name="2_a_3_años_m" id="2_a_3_años_m2"
                                value="{{ old('2_a_3_años_m', $censoBovino->dos_a_3_años_m) }}"
                                oninput="calculateTotalMachos2()">
                        </div>

                        <div class="mb-3">
                            <label for="may_3_años" class="form-label">Mayores de 3 años (Machos):</label>
                            <input type="number" class="form-control" name="may_3_años" id="may_3_años2"
                                value="{{ old('may_3_años', $censoBovino->may_3_años) }}"
                                oninput="calculateTotalMachos2()">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="total_machos" id="total_machos2"
                                value="{{ old('total_machos', $censoBovino->total_machos) }}" readonly>
                        </div>

                        <!-- Total de Bovinos -->
                        <div class="mb-3">
                            <label for="total_bovinos" class="form-label">Total Bovinos:</label>
                            <input type="number" class="form-control" name="total_bovinos" id="total_bovinos2"
                                value="{{ old('total_bovinos', $censoBovino->total_bovinos) }}" readonly>
                        </div>

                        <button type="submit" class="btn btn-primary">Actualizar Censo</button>
                    </form>
                @else
                    <form action="{{ route('censo.store') }}" method="POST">
                        @csrf
                        <!-- Input oculto para id_predio -->
                        ...
                        <div class="mb-3">
                            <label for="total_bovinos" class="form-label">Total Bovinos:</label>
                            <input type="number" class="form-control" name="total_bovinos" id="total_bovinos"
    ...
    <script>
        ...
        function calculateTotalBovinos2() {
            ...
            document.getElementById('total_bovinos2').value = total_bovinos;
        }
    </script>
@endsection
